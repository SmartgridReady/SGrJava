...
/opt/eclipse/eclipse -console -noSplash -data ../ -application org.eclipse.emf.codegen.ecore.Generator -forceOverwrite SGrSpecification/model/SGrSpecification.genmodel SGrSpecification

echo 'copy sources to projectdir'
cp -r /SGrSpecification/src /host/projectdir/SGrJava/SGrJava/SGrSpecification
chmod -R 777 /host/projectdir/SGrJava/SGrJava/SGrSpecification