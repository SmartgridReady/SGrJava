...
import ch.smartgridready.sgr.ns.v0.ProfileTypeEnumType;
import ch.smartgridready.sgr.ns.v0.SGrProfilenumberType;
import ch.smartgridready.sgr.ns.v0.SGrVersionNumberType;
import ch.smartgridready.sgr.ns.v0.SubProfileTypeEnumType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrProfilenumberTypeImpl#getSpecsOwnerId <em>Specs Owner Id</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrProfilenumberTypeImpl#getProfileIdentification <em>Profile Identification</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrProfilenumberTypeImpl#getSubProfileIdent <em>Sub Profile Ident</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrProfilenumberTypeImpl#getSgrLevelOfOperation <em>Sgr Level Of Operation</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrProfilenumberTypeImpl#getVersionNumber <em>Version Number</em>}</li>
 * </ul>
 *
 * @generated
 */
