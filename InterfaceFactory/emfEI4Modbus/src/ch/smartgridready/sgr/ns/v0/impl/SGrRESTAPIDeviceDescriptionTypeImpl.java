...
import ch.smartgridready.sgr.ns.v0.SGrRestAPIProfilesFrameType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getDeviceProfile <em>Device Profile</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getDevRestAPIAttrReference <em>Dev Rest API Attr Reference</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getRestAPIInterfaceDesc <em>Rest API Interface Desc</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getFpListElement <em>Fp List Element</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getDeviceName <em>Device Name</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#isIsLocalControl <em>Is Local Control</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getManufacturerID <em>Manufacturer ID</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrRESTAPIDeviceDescriptionTypeImpl#getManufacturerName <em>Manufacturer Name</em>}</li>
 * </ul>
 *
 * @generated
 */
