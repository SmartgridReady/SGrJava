 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getDeviceProfile <em>Device Profile</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getDevAttr4Generic <em>Dev Attr4 Generic</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getFpListElement <em>Fp List Element</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getDeviceName <em>Device Name</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#isIsLocalControl <em>Is Local Control</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getManufacturerID <em>Manufacturer ID</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getManufacturerName <em>Manufacturer Name</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType()
...
public interface SGrDeviceDescriptionType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_DeviceProfile()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getDeviceProfile <em>Device Profile</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_DevAttr4Generic()
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_FpListElement()
	 * @model containment="true" required="true"
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_DeviceName()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getDeviceName <em>Device Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_IsLocalControl()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#isIsLocalControl <em>Is Local Control</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#isIsLocalControl <em>Is Local Control</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetIsLocalControl()
	 * @see #isIsLocalControl()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#isIsLocalControl <em>Is Local Control</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_ManufacturerID()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getManufacturerID <em>Manufacturer ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getManufacturerID <em>Manufacturer ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetManufacturerID()
	 * @see #getManufacturerID()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getManufacturerID <em>Manufacturer ID</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDeviceDescriptionType_ManufacturerName()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType#getManufacturerName <em>Manufacturer Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
