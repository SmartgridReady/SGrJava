 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getAddr <em>Addr</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getBitRank <em>Bit Rank</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getRegisterType <em>Register Type</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getTSGrModbusRegisterRef()
...
public interface TSGrModbusRegisterRef extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getTSGrModbusRegisterRef_Addr()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getAddr <em>Addr</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getTSGrModbusRegisterRef_BitRank()
	 * @model unsettable="true" dataType="ch.smartgridready.sgr.ns.v0.TBitRank"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getBitRank <em>Bit Rank</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getBitRank <em>Bit Rank</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetBitRank()
	 * @see #getBitRank()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getBitRank <em>Bit Rank</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link ch.smartgridready.sgr.ns.v0.TEnumObjectType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getTSGrModbusRegisterRef_RegisterType()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getRegisterType <em>Register Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getRegisterType <em>Register Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetRegisterType()
	 * @see #getRegisterType()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef#getRegisterType <em>Register Type</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
