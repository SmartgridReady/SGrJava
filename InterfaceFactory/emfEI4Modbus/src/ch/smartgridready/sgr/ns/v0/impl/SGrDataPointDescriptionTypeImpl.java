...
import ch.smartgridready.sgr.ns.v0.SGrMROPresenceLevelIndicationType;
import ch.smartgridready.sgr.ns.v0.SGrNamelistType;
import ch.smartgridready.sgr.ns.v0.SGrRWPType;
import ch.smartgridready.sgr.ns.v0.SGrUnits;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getBasicDataType <em>Basic Data Type</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getDpNameList <em>Dp Name List</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getDpLegibDesc <em>Dp Legib Desc</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getDatapointName <em>Datapoint Name</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getMroVisibilityIndicator <em>Mro Visibility Indicator</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getRwpDatadirection <em>Rwp Datadirection</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrDataPointDescriptionTypeImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
