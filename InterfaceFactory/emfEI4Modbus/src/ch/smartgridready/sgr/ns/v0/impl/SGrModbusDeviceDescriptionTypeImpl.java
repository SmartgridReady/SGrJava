...
import ch.smartgridready.sgr.ns.v0.SGrManufacturerIDType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getDeviceProfile <em>Device Profile</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getDevMbAttrReference <em>Dev Mb Attr Reference</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getModbusInterfaceDesc <em>Modbus Interface Desc</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getFpListElement <em>Fp List Element</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getNetworkConnectionState <em>Network Connection State</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getDeviceName <em>Device Name</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#isIsLocalControl <em>Is Local Control</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getManufacturerID <em>Manufacturer ID</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDeviceDescriptionTypeImpl#getManufacturerName <em>Manufacturer Name</em>}</li>
 * </ul>
 *
 * @generated
 */
