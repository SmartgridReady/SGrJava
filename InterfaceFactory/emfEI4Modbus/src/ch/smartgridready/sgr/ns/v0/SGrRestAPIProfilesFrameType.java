 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestAPIProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestAPIProfilesFrameType#getFpRestAPIAttrReference <em>Fp Rest API Attr Reference</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestAPIProfilesFrameType#getDpListElement <em>Dp List Element</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestAPIProfilesFrameType()
...
public interface SGrRestAPIProfilesFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestAPIProfilesFrameType_FunctionalProfile()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrRestAPIProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestAPIProfilesFrameType_FpRestAPIAttrReference()
	 ...
	 * The list contents are of type {@link ch.smartgridready.sgr.ns.v0.SGrRestAPIDataPointsFrameType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Dp List Element</em>' containment reference list.
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestAPIProfilesFrameType_DpListElement()
	 * @model containment="true" required="true"
