...
import ch.smartgridready.sgr.ns.v0.SGrFlexAssistanceType;
...
import ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getSpecQualityRequirement <em>Spec Quality Requirement</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getStabilityFallback <em>Stability Fallback</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getSmoothTransition <em>Smooth Transition</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMinSendDelta <em>Min Send Delta</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMaxSendTime <em>Max Send Time</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMaxReceiveTime <em>Max Receive Time</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMinSendTime <em>Min Send Time</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMaxLatencyTime <em>Max Latency Time</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getTimeStampLog <em>Time Stamp Log</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getTimeRange <em>Time Range</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getValueState <em>Value State</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getValueTendency <em>Value Tendency</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getValueSource <em>Value Source</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getSampleRate <em>Sample Rate</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getCurtailment <em>Curtailment</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMinLoad <em>Min Load</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMaxLockTimeMinutes <em>Max Lock Time Minutes</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getMinRunTimeMinutes <em>Min Run Time Minutes</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getValueByTimeTableMinutes <em>Value By Time Table Minutes</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrAttr4GenericTypeImpl#getFlexAssistance <em>Flex Assistance</em>}</li>
 * </ul>
 *
 * @generated
 */
