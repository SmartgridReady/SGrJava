 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestBasicType#getRestBasicUsername <em>Rest Basic Username</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestBasicType#getRestBasicPassword <em>Rest Basic Password</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestBasicType()
...
public interface SGrRestBasicType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestBasicType_RestBasicUsername()
	 * @model dataType="ch.smartgridready.sgr.ns.v0.RestBasicUsernameType" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrRestBasicType#getRestBasicUsername <em>Rest Basic Username</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestBasicType_RestBasicPassword()
	 * @model dataType="ch.smartgridready.sgr.ns.v0.RestBasicPasswordType" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrRestBasicType#getRestBasicPassword <em>Rest Basic Password</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
