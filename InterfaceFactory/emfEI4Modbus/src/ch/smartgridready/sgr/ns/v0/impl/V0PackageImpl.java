...
import ch.smartgridready.sgr.ns.v0.util.V0Validator;
...
public class V0PackageImpl extends EPackageImpl implements V0Package {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("ch.smartgridready.sgr.ns.v0." + eClassifier.getName());
