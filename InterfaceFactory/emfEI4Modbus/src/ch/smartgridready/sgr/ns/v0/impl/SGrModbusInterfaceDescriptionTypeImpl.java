...
import ch.smartgridready.sgr.ns.v0.ModbusInterfaceSelectionType;
import ch.smartgridready.sgr.ns.v0.SGrModbusInterfaceDescriptionType;
import ch.smartgridready.sgr.ns.v0.TEnumConversionFct;
import ch.smartgridready.sgr.ns.v0.TPIPModbus;
import ch.smartgridready.sgr.ns.v0.TPRTUModbus;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusInterfaceDescriptionTypeImpl#getModbusInterfaceSelection <em>Modbus Interface Selection</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusInterfaceDescriptionTypeImpl#getTrspSrvModbusTCPoutOfBox <em>Trsp Srv Modbus TC Pout Of Box</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusInterfaceDescriptionTypeImpl#getTrspSrvModbusRTUoutOfBox <em>Trsp Srv Modbus RT Uout Of Box</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusInterfaceDescriptionTypeImpl#isFirstRegisterAddressIsOne <em>First Register Address Is One</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusInterfaceDescriptionTypeImpl#getConversionScheme <em>Conversion Scheme</em>}</li>
 * </ul>
 *
 * @generated
 */
