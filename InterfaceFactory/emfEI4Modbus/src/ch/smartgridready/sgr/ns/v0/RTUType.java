 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.RTUType#getRtuTrspSrvInstance <em>Rtu Trsp Srv Instance</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.RTUType#getRtuDevInstance <em>Rtu Dev Instance</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getRTUType()
...
public interface RTUType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getRTUType_RtuTrspSrvInstance()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.RTUType#getRtuTrspSrvInstance <em>Rtu Trsp Srv Instance</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.smartgridready.sgr.ns.v0.RTUDevInstanceType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Rtu Dev Instance</em>' containment reference list.
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getRTUType_RtuDevInstance()
