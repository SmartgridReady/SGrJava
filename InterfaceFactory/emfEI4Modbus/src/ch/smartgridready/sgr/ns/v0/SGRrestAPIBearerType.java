 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGRrestAPIBearerType#getRestAPIEndPoint <em>Rest API End Point</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGRrestAPIBearerType#getRestAPIJMESPath <em>Rest APIJMES Path</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGRrestAPIBearerType()
...
public interface SGRrestAPIBearerType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGRrestAPIBearerType_RestAPIEndPoint()
	 * @model dataType="ch.smartgridready.sgr.ns.v0.RestAPIEndPointType1" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGRrestAPIBearerType#getRestAPIEndPoint <em>Rest API End Point</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGRrestAPIBearerType_RestAPIJMESPath()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGRrestAPIBearerType#getRestAPIJMESPath <em>Rest APIJMES Path</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
