...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Network Connection State Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.NetworkConnectionStateTypeImpl#isIsConnected <em>Is Connected</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.NetworkConnectionStateTypeImpl#getNextAttempt <em>Next Attempt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkConnectionStateTypeImpl extends MinimalEObjectImpl.Container implements NetworkConnectionStateType {
	/**
	 ...
	 * @generated
	 */
	protected NetworkConnectionStateTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return V0Package.eINSTANCE.getNetworkConnectionStateType();
	}
	...
	public void setIsConnected(boolean newIsConnected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V0Package.NETWORK_CONNECTION_STATE_TYPE__IS_CONNECTED, oldIsConnected, isConnected, !oldIsConnectedESet));
	}
	...
	public void unsetIsConnected() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, V0Package.NETWORK_CONNECTION_STATE_TYPE__IS_CONNECTED, oldIsConnected, IS_CONNECTED_EDEFAULT, oldIsConnectedESet));
	}
	...
	public void setNextAttempt(XMLGregorianCalendar newNextAttempt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V0Package.NETWORK_CONNECTION_STATE_TYPE__NEXT_ATTEMPT, oldNextAttempt, nextAttempt));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case V0Package.NETWORK_CONNECTION_STATE_TYPE__IS_CONNECTED:
				return isIsConnected();
			case V0Package.NETWORK_CONNECTION_STATE_TYPE__NEXT_ATTEMPT:
...
} //NetworkConnectionStateTypeImpl
