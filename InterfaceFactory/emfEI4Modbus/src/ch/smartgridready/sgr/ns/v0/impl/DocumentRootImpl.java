...
import ch.smartgridready.sgr.ns.v0.DocumentRoot;
import ch.smartgridready.sgr.ns.v0.EBaudRateType;
import ch.smartgridready.sgr.ns.v0.EByteLenType;
import ch.smartgridready.sgr.ns.v0.EParityType;
import ch.smartgridready.sgr.ns.v0.EStopBitLenType;
import ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType;
import ch.smartgridready.sgr.ns.v0.SGrContactAPIDeviceDescriptionType;
import ch.smartgridready.sgr.ns.v0.SGrDeviceDescriptionType;
import ch.smartgridready.sgr.ns.v0.SGrDeviceProfileType;
import ch.smartgridready.sgr.ns.v0.SGrModbusDataPointDescriptionType;
import ch.smartgridready.sgr.ns.v0.SGrModbusDeviceDescriptionType;
import ch.smartgridready.sgr.ns.v0.SGrModbusInterfaceDescriptionType;
...
import ch.smartgridready.sgr.ns.v0.SGrSerialInterfaceCapabilityType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getBaudRatesSupported <em>Baud Rates Supported</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getByteLenSupported <em>Byte Len Supported</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getDeviceProfile <em>Device Profile</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getFunctionalProfiles <em>Functional Profiles</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getGenDeviceFrame <em>Gen Device Frame</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getModbusFunctionCodesSupported <em>Modbus Function Codes Supported</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getNetConnectionState <em>Net Connection State</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getParitySupported <em>Parity Supported</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrModbusDataPointDescription <em>SGr Modbus Data Point Description</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrModbusInterfaceDescription <em>SGr Modbus Interface Description</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSgrContactAPIDeviceFrame <em>Sgr Contact API Device Frame</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrContactAPIDeviceDescriptionType <em>SGr Contact API Device Description Type</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrModbusDeviceDescriptionType <em>SGr Modbus Device Description Type</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrModbusDeviceFrame <em>SGr Modbus Device Frame</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrRESTAPIDeviceDescriptionType <em>SGr RESTAPI Device Description Type</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSGrRestAPIDeviceFrame <em>SGr Rest API Device Frame</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getSgrSerialInterfaceCapability <em>Sgr Serial Interface Capability</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getStopBitLenSupported <em>Stop Bit Len Supported</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.DocumentRootImpl#getTrspServiceModbus <em>Trsp Service Modbus</em>}</li>
 * </ul>
 *
 * @generated
 */
