 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestProfilesFrameType#getFpRestAPIAttrReference <em>Fp Rest API Attr Reference</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrRestProfilesFrameType#getDpListElement <em>Dp List Element</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestProfilesFrameType()
...
public interface SGrRestProfilesFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestProfilesFrameType_FunctionalProfile()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrRestProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestProfilesFrameType_FpRestAPIAttrReference()
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrRestProfilesFrameType_DpListElement()
	 * @model containment="true" required="true"
