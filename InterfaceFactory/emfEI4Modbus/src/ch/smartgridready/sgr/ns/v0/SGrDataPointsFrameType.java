 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDataPointsFrameType#getDataPoint <em>Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrDataPointsFrameType#getDpAttr4Generic <em>Dp Attr4 Generic</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDataPointsFrameType()
...
public interface SGrDataPointsFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDataPointsFrameType_DataPoint()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrDataPointsFrameType#getDataPoint <em>Data Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrDataPointsFrameType_DpAttr4Generic()
