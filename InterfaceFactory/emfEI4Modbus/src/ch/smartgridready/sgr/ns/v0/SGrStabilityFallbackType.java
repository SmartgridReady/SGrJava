 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getMaxReceiveTime <em>Max Receive Time</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getInitValue <em>Init Value</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getFallbackValue <em>Fallback Value</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrStabilityFallbackType()
...
public interface SGrStabilityFallbackType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrStabilityFallbackType_MaxReceiveTime()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getMaxReceiveTime <em>Max Receive Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrStabilityFallbackType_InitValue()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getInitValue <em>Init Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getInitValue <em>Init Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetInitValue()
	 * @see #getInitValue()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getInitValue <em>Init Value</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getSGrStabilityFallbackType_FallbackValue()
	 * @model unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Float" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getFallbackValue <em>Fallback Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getFallbackValue <em>Fallback Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetFallbackValue()
	 * @see #getFallbackValue()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.SGrStabilityFallbackType#getFallbackValue <em>Fallback Value</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
