...
import ch.smartgridready.sgr.ns.v0.DpAccessProtectionEnabledType;
import ch.smartgridready.sgr.ns.v0.MasterFunctionsSupportedType;
import ch.smartgridready.sgr.ns.v0.ModbusJMESPathType;
...
import ch.smartgridready.sgr.ns.v0.TSGrModbusRegisterRef;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getModbusDataType <em>Modbus Data Type</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getModbusFirstRegisterReference <em>Modbus First Register Reference</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getDpSizeNrRegisters <em>Dp Size Nr Registers</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getBitmask <em>Bitmask</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getMasterFunctionsSupported <em>Master Functions Supported</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getModbusJMESPath <em>Modbus JMES Path</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getDpAccessProtectionEnabled <em>Dp Access Protection Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SGrModbusDataPointDescriptionTypeImpl extends MinimalEObjectImpl.Container implements SGrModbusDataPointDescriptionType {
	...
	/**
	 * The cached value of the '{@link #getDpAccessProtectionEnabled() <em>Dp Access Protection Enabled</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDpAccessProtectionEnabled()
	 * @generated
	 * @ordered
	 */
	 ...
	 */
	@Override
	public EList<DpAccessProtectionEnabledType> getDpAccessProtectionEnabled() {
		if (dpAccessProtectionEnabled == null) {
			dpAccessProtectionEnabled = new EObjectContainmentEList<DpAccessProtectionEnabledType>(DpAccessProtectionEnabledType.class, this, V0Package.SGR_MODBUS_DATA_POINT_DESCRIPTION_TYPE__DP_ACCESS_PROTECTION_ENABLED);
		}
		return dpAccessProtectionEnabled;
	}
