 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType#isIsConnected <em>Is Connected</em>}</li>
 *   <li>{@link ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType#getNextAttempt <em>Next Attempt</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.sgr.ns.v0.V0Package#getNetworkConnectionStateType()
...
public interface NetworkConnectionStateType extends EObject {
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getNetworkConnectionStateType_IsConnected()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType#isIsConnected <em>Is Connected</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType#isIsConnected <em>Is Connected</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetIsConnected()
	 * @see #isIsConnected()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType#isIsConnected <em>Is Connected</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.sgr.ns.v0.V0Package#getNetworkConnectionStateType_NextAttempt()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.sgr.ns.v0.NetworkConnectionStateType#getNextAttempt <em>Next Attempt</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
