...
import ch.smartgridready.ns.s.gr.v0.SGrDeviceKindType;
...
import ch.smartgridready.ns.s.gr.v0.SGrVersionNumberType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getDevNameList <em>Dev Name List</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getDevLegibDesc <em>Dev Legib Desc</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getTransportService <em>Transport Service</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getDeviceKind <em>Device Kind</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getSerialNumber <em>Serial Number</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getSoftwareRevision <em>Software Revision</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getHardwareRevision <em>Hardware Revision</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getBrandName <em>Brand Name</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getPowerSource <em>Power Source</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getNominalPower <em>Nominal Power</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getManufSpecIdent <em>Manuf Spec Ident</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getManufacturerLabel <em>Manufacturer Label</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getRemAuthorID <em>Rem Author ID</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrDeviceProfileTypeImpl#getDevLevelofOperation <em>Dev Levelof Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
