 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.TPRTUModbusImpl#getSlaveAddr <em>Slave Addr</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.TPRTUModbusImpl#getBaudRateSelected <em>Baud Rate Selected</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.TPRTUModbusImpl#getByteLenSelected <em>Byte Len Selected</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.TPRTUModbusImpl#getParitySelected <em>Parity Selected</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.TPRTUModbusImpl#getStopBitLenSelected <em>Stop Bit Len Selected</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.TPRTUModbusImpl#getSerialInterfaceCapability <em>Serial Interface Capability</em>}</li>
 * </ul>
 *
 * @generated
 */
