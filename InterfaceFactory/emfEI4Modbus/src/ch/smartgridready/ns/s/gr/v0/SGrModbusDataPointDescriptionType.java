 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getModbusDataType <em>Modbus Data Type</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getModbusFirstRegisterReference <em>Modbus First Register Reference</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getDpSizeNrRegisters <em>Dp Size Nr Registers</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getBitmask <em>Bitmask</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getMasterFunctionsSupported <em>Master Functions Supported</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getModbusJMESPath <em>Modbus JMES Path</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getDpAccessProtectionEnabled <em>Dp Access Protection Enabled</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType()
...
public interface SGrModbusDataPointDescriptionType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_ModbusDataType()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getModbusDataType <em>Modbus Data Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_ModbusFirstRegisterReference()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getModbusFirstRegisterReference <em>Modbus First Register Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_DpSizeNrRegisters()
	 * @model unsettable="true" dataType="ch.smartgridready.ns.s.gr.v0.DpSizeNrRegistersType" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getDpSizeNrRegisters <em>Dp Size Nr Registers</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getDpSizeNrRegisters <em>Dp Size Nr Registers</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetDpSizeNrRegisters()
	 * @see #getDpSizeNrRegisters()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getDpSizeNrRegisters <em>Dp Size Nr Registers</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBitmask(byte[])
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_Bitmask()
	 * @model dataType="ch.smartgridready.ns.s.gr.v0.BitmaskType"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getBitmask <em>Bitmask</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.MasterFunctionsSupportedType}.
	 * The literals are from the enumeration {@link ch.smartgridready.ns.s.gr.v0.MasterFunctionsSupportedType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_MasterFunctionsSupported()
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_ModbusJMESPath()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType#getModbusJMESPath <em>Modbus JMES Path</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Dp Access Protection Enabled</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointDescriptionType_DpAccessProtectionEnabled()
	 * @model containment="true"
