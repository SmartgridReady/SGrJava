 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrSerialInterfaceCapabilityType#getBaudRatesSupported <em>Baud Rates Supported</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrSerialInterfaceCapabilityType#getByteLenSupported <em>Byte Len Supported</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrSerialInterfaceCapabilityType#getParitySupported <em>Parity Supported</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrSerialInterfaceCapabilityType#getStopBitLenSupported <em>Stop Bit Len Supported</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrSerialInterfaceCapabilityType()
...
public interface SGrSerialInterfaceCapabilityType extends EObject {
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.EBaudRateType}.
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrSerialInterfaceCapabilityType_BaudRatesSupported()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.EByteLenType}.
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrSerialInterfaceCapabilityType_ByteLenSupported()
	 * @model unique="false" required="true"
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.EParityType}.
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrSerialInterfaceCapabilityType_ParitySupported()
	 * @model unique="false" required="true"
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.EStopBitLenType}.
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrSerialInterfaceCapabilityType_StopBitLenSupported()
	 * @model unique="false" required="true"
