 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.TPipV6genAddrType#getPrelimStringDef <em>Prelim String Def</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getTPipV6genAddrType()
...
public interface TPipV6genAddrType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getTPipV6genAddrType_PrelimStringDef()
	 * @model dataType="ch.smartgridready.ns.s.gr.v0.PrelimStringDefType" required="true"
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.TPipV6genAddrType#getPrelimStringDef <em>Prelim String Def</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
