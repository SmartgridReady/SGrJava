...
import ch.smartgridready.ns.s.gr.v0.SGrAttr4ModbusType;
import ch.smartgridready.ns.s.gr.v0.SGrScalingType;
import ch.smartgridready.ns.s.gr.v0.TimeSyncBlockNotificationType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrAttr4ModbusTypeImpl#getScalingByMulPwr <em>Scaling By Mul Pwr</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrAttr4ModbusTypeImpl#getStepByIncrement <em>Step By Increment</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrAttr4ModbusTypeImpl#getSunssf <em>Sunssf</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrAttr4ModbusTypeImpl#getPollLatencyMS <em>Poll Latency MS</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrAttr4ModbusTypeImpl#getTimeSyncBlockNotification <em>Time Sync Block Notification</em>}</li>
 * </ul>
 *
 * @generated
 */
