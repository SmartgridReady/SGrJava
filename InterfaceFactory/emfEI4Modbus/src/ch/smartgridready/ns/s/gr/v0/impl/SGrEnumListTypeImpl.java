 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrMeasValueState <em>Sgr Meas Value State</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrMeasValueTendency <em>Sgr Meas Value Tendency</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrMeasValueSource <em>Sgr Meas Value Source</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrPowerSource <em>Sgr Power Source</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgreadyStateLv2 <em>Sgready State Lv2</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgreadyStateLv1 <em>Sgready State Lv1</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrSunspStateCodes <em>Sgr Sunsp State Codes</em>}</li>
 ...
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrEVState <em>Sgr EV State</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrSGCPService <em>Sgr SGCP Service</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrEnumListTypeImpl#getSgrObligLvl <em>Sgr Oblig Lvl</em>}</li>
 * </ul>
 *
 * @generated
 */
