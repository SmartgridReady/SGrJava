...
import ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType;
import ch.smartgridready.ns.s.gr.v0.MasterFunctionsSupportedType;
import ch.smartgridready.ns.s.gr.v0.ModbusJMESPathType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getModbusDataType <em>Modbus Data Type</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getModbusFirstRegisterReference <em>Modbus First Register Reference</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getDpSizeNrRegisters <em>Dp Size Nr Registers</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getBitmask <em>Bitmask</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getMasterFunctionsSupported <em>Master Functions Supported</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getModbusJMESPath <em>Modbus JMES Path</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrModbusDataPointDescriptionTypeImpl#getDpAccessProtectionEnabled <em>Dp Access Protection Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
