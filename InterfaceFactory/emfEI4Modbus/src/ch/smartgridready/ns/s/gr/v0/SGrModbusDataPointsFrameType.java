 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointsFrameType#getDataPoint <em>Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointsFrameType#getModbusDataPoint <em>Modbus Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointsFrameType#getDpMbAttrReference <em>Dp Mb Attr Reference</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointsFrameType()
...
public interface SGrModbusDataPointsFrameType extends EObject {
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrDataPointDescriptionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Point</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointsFrameType_DataPoint()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointDescriptionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointsFrameType_ModbusDataPoint()
	 * @model containment="true" required="true"
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusDataPointsFrameType_DpMbAttrReference()
