 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrBasicGenDataPointTypeType#getBoolean <em>Boolean</em>}</li>
 ...
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrBasicGenDataPointTypeType#getTnum <em>Tnum</em>}</li>
...
public interface SGrBasicGenDataPointTypeType extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Tnum</b></em>' containment reference list.
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrEnumListType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Tnum</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrBasicGenDataPointTypeType_Tnum()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='tnum' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<SGrEnumListType> getTnum();
