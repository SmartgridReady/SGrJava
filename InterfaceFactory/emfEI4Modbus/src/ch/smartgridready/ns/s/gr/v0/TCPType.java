 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.TCPType#getTcpTrspSrvInstance <em>Tcp Trsp Srv Instance</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.TCPType#getTcpDevInstance <em>Tcp Dev Instance</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getTCPType()
...
public interface TCPType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getTCPType_TcpTrspSrvInstance()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.TCPType#getTcpTrspSrvInstance <em>Tcp Trsp Srv Instance</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.TCPDevInstanceType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Tcp Dev Instance</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getTCPType_TcpDevInstance()
