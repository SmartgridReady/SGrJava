...
import ch.smartgridready.ns.s.gr.v0.ProfileTypeEnumType;
import ch.smartgridready.ns.s.gr.v0.SGrProfilenumberType;
import ch.smartgridready.ns.s.gr.v0.SGrVersionNumberType;
import ch.smartgridready.ns.s.gr.v0.SubProfileTypeEnumType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrProfilenumberTypeImpl#getSpecsOwnerId <em>Specs Owner Id</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrProfilenumberTypeImpl#getProfileIdentification <em>Profile Identification</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrProfilenumberTypeImpl#getSubProfileIdent <em>Sub Profile Ident</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrProfilenumberTypeImpl#getSgrLevelOfOperation <em>Sgr Level Of Operation</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrProfilenumberTypeImpl#getVersionNumber <em>Version Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SGrProfilenumberTypeImpl extends MinimalEObjectImpl.Container implements SGrProfilenumberType {
	 ...
	 * @ordered
	 */
	protected static final SubProfileTypeEnumType SUB_PROFILE_IDENT_EDEFAULT = SubProfileTypeEnumType.ACTIVE_ENERGY_AC;
