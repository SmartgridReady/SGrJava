 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getNumContacts <em>Num Contacts</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getContactStabilisationTimeMs <em>Contact Stabilisation Time Ms</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getContactAPIInterfaceDescType()
...
public interface ContactAPIInterfaceDescType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getContactAPIInterfaceDescType_NumContacts()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getNumContacts <em>Num Contacts</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getNumContacts <em>Num Contacts</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetNumContacts()
	 * @see #getNumContacts()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getNumContacts <em>Num Contacts</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getContactAPIInterfaceDescType_ContactStabilisationTimeMs()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getContactStabilisationTimeMs <em>Contact Stabilisation Time Ms</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getContactStabilisationTimeMs <em>Contact Stabilisation Time Ms</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetContactStabilisationTimeMs()
	 * @see #getContactStabilisationTimeMs()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType#getContactStabilisationTimeMs <em>Contact Stabilisation Time Ms</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
