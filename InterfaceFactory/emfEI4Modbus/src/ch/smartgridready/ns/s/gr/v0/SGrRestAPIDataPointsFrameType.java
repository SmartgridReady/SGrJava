 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestAPIDataPointsFrameType#getDataPoint <em>Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestAPIDataPointsFrameType#getRestAPIDataPoint <em>Rest API Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestAPIDataPointsFrameType#getDpRestAPIAttrReference <em>Dp Rest API Attr Reference</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIDataPointsFrameType()
...
public interface SGrRestAPIDataPointsFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIDataPointsFrameType_DataPoint()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrRestAPIDataPointDescriptionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIDataPointsFrameType_RestAPIDataPoint()
	 * @model containment="true" required="true"
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIDataPointsFrameType_DpRestAPIAttrReference()
