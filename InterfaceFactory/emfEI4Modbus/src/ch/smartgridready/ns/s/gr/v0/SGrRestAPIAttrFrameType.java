 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestAPIAttrFrameType#getGenAttribute <em>Gen Attribute</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestAPIAttrFrameType#getRestAPIAttr <em>Rest API Attr</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIAttrFrameType()
...
public interface SGrRestAPIAttrFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIAttrFrameType_GenAttribute()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrAttr4RestAPIType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Rest API Attr</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestAPIAttrFrameType_RestAPIAttr()
	 * @model containment="true"
