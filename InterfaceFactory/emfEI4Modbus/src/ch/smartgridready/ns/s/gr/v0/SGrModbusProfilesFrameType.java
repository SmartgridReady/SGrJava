 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusProfilesFrameType#getFpMbAttrReference <em>Fp Mb Attr Reference</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusProfilesFrameType#getDpListElement <em>Dp List Element</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusProfilesFrameType()
...
public interface SGrModbusProfilesFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusProfilesFrameType_FunctionalProfile()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrModbusProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusProfilesFrameType_FpMbAttrReference()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrModbusDataPointsFrameType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Dp List Element</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusProfilesFrameType_DpListElement()
	 * @model containment="true" required="true"
