 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestDataPointsFrameType#getDataPoint <em>Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestDataPointsFrameType#getRestDataPoint <em>Rest Data Point</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrRestDataPointsFrameType#getDpRestAPIAttrReference <em>Dp Rest API Attr Reference</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestDataPointsFrameType()
...
public interface SGrRestDataPointsFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestDataPointsFrameType_DataPoint()
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestDataPointsFrameType_RestDataPoint()
	 * @model containment="true" required="true"
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrRestDataPointsFrameType_DpRestAPIAttrReference()
