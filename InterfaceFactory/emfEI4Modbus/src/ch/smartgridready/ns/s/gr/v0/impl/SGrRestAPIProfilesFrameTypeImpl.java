...
import ch.smartgridready.ns.s.gr.v0.SGrProfileDescriptionType;
import ch.smartgridready.ns.s.gr.v0.SGrRestAPIAttrFrameType;
import ch.smartgridready.ns.s.gr.v0.SGrRestAPIDataPointsFrameType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIProfilesFrameTypeImpl#getFunctionalProfile <em>Functional Profile</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIProfilesFrameTypeImpl#getFpRestAPIAttrReference <em>Fp Rest API Attr Reference</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIProfilesFrameTypeImpl#getDpListElement <em>Dp List Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SGrRestAPIProfilesFrameTypeImpl extends MinimalEObjectImpl.Container implements SGrRestAPIProfilesFrameType {
	...
	public EList<SGrRestAPIAttrFrameType> getFpRestAPIAttrReference() {
		if (fpRestAPIAttrReference == null) {
			fpRestAPIAttrReference = new EObjectContainmentEList<SGrRestAPIAttrFrameType>(SGrRestAPIAttrFrameType.class, this, V0Package.SGR_REST_API_PROFILES_FRAME_TYPE__FP_REST_API_ATTR_REFERENCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case V0Package.SGR_REST_API_PROFILES_FRAME_TYPE__FP_REST_API_ATTR_REFERENCE:
