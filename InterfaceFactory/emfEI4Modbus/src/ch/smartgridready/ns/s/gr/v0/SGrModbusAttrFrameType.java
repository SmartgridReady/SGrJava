 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusAttrFrameType#getGenAttribute <em>Gen Attribute</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrModbusAttrFrameType#getModbusAttr <em>Modbus Attr</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusAttrFrameType()
...
public interface SGrModbusAttrFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusAttrFrameType_GenAttribute()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrAttr4ModbusType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Modbus Attr</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrModbusAttrFrameType_ModbusAttr()
	 * @model containment="true"
