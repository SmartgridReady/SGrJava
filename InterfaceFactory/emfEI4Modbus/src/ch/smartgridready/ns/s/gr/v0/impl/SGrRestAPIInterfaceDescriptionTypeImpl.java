...
import ch.smartgridready.ns.s.gr.v0.SGRrestAPIBearerType;
import ch.smartgridready.ns.s.gr.v0.SGrRestAPIAuthenticationEnumMethodType;
import ch.smartgridready.ns.s.gr.v0.SGrRestAPIInterfaceDescriptionType;
import ch.smartgridready.ns.s.gr.v0.SGrRestAPIInterfaceSelectiontype;
import ch.smartgridready.ns.s.gr.v0.SGrRestBasicType;
import ch.smartgridready.ns.s.gr.v0.TPipV4genAddrType;
import ch.smartgridready.ns.s.gr.v0.TPipV6genAddrType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getRestAPIInterfaceSelection <em>Rest API Interface Selection</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getTrspSrvRestTCPV4outOfBox <em>Trsp Srv Rest TCPV 4out Of Box</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getTrspSrvRestTCPV6outOfBox <em>Trsp Srv Rest TCPV 6out Of Box</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getTrspSrvRestURIoutOfBox <em>Trsp Srv Rest UR Iout Of Box</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getRestAPIAuthenticationMethod <em>Rest API Authentication Method</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getRestAPIBearer <em>Rest API Bearer</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrRestAPIInterfaceDescriptionTypeImpl#getRestAPIBasic <em>Rest API Basic</em>}</li>
 * </ul>
 *
 * @generated
 */
