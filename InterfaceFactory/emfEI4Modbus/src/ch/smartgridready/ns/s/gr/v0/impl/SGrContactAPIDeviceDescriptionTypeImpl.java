...
import ch.smartgridready.ns.s.gr.v0.ContactAPIInterfaceDescType;
 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getDeviceProfile <em>Device Profile</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getDevAttr4Generic <em>Dev Attr4 Generic</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getContactApiInterfaceDesc <em>Contact Api Interface Desc</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getFpListElement <em>Fp List Element</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getDeviceName <em>Device Name</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#isIsLocalControl <em>Is Local Control</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getManufacturerID <em>Manufacturer ID</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.impl.SGrContactAPIDeviceDescriptionTypeImpl#getManufacturerName <em>Manufacturer Name</em>}</li>
 * </ul>
 *
 * @generated
 */
