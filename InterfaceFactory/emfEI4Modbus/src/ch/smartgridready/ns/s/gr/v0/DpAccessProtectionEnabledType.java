 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#getModbusException <em>Modbus Exception</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#isIsEnabled <em>Is Enabled</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getDpAccessProtectionEnabledType()
...
public interface DpAccessProtectionEnabledType extends EObject {
	 ...
	 * The literals are from the enumeration {@link ch.smartgridready.ns.s.gr.v0.TEnumExceptionCodeType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getDpAccessProtectionEnabledType_ModbusException()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#getModbusException <em>Modbus Exception</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#getModbusException <em>Modbus Exception</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetModbusException()
	 * @see #getModbusException()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#getModbusException <em>Modbus Exception</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getDpAccessProtectionEnabledType_IsEnabled()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#isIsEnabled <em>Is Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#isIsEnabled <em>Is Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetIsEnabled()
	 * @see #isIsEnabled()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.DpAccessProtectionEnabledType#isIsEnabled <em>Is Enabled</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
