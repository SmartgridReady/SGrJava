 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#getTechnologyUsed <em>Technology Used</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#isIsLocalControl <em>Is Local Control</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrInterfaceDescriptionType()
...
public interface SGrInterfaceDescriptionType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrInterfaceDescriptionType_TechnologyUsed()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#getTechnologyUsed <em>Technology Used</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#getTechnologyUsed <em>Technology Used</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetTechnologyUsed()
	 * @see #getTechnologyUsed()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#getTechnologyUsed <em>Technology Used</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrInterfaceDescriptionType_IsLocalControl()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#isIsLocalControl <em>Is Local Control</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#isIsLocalControl <em>Is Local Control</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetIsLocalControl()
	 * @see #isIsLocalControl()
	...
	/**
	 * Returns whether the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrInterfaceDescriptionType#isIsLocalControl <em>Is Local Control</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
