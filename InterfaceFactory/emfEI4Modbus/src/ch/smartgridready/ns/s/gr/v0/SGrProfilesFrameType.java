 ...
 * </p>
 * <ul>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrProfilesFrameType#getFpAttr4Generic <em>Fp Attr4 Generic</em>}</li>
 *   <li>{@link ch.smartgridready.ns.s.gr.v0.SGrProfilesFrameType#getDpListElement <em>Dp List Element</em>}</li>
 * </ul>
 *
 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrProfilesFrameType()
...
public interface SGrProfilesFrameType extends EObject {
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrProfilesFrameType_FunctionalProfile()
	...
	/**
	 * Sets the value of the '{@link ch.smartgridready.ns.s.gr.v0.SGrProfilesFrameType#getFunctionalProfile <em>Functional Profile</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrProfilesFrameType_FpAttr4Generic()
	 ...
	 * The list contents are of type {@link ch.smartgridready.ns.s.gr.v0.SGrDataPointsFrameType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Dp List Element</em>' containment reference list.
	 * @see ch.smartgridready.ns.s.gr.v0.V0Package#getSGrProfilesFrameType_DpListElement()
	 * @model containment="true" required="true"
